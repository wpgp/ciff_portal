        ...
        */}
        ...
        <div className='col-lg-5 pb-3'>
          ...
          <ol>
            ...
            <li>Select an administrative unit by clicking any region on the map.</li>
          ...
          <ol start={9}>
            <li>If the underlying dataset is statistically sufficient to estimate the significance in change between rounds, 'Filtering by change' can be performed.</li>
            <li>Use the dropdown to display subnational units with significant improvement or worsening through time for the selected indicator. This allows the user to choose the probability that there is meaningful improvement/worsening. The map filters out units where it is unlikely that there have been meaningful improvements.</li>
            ...
            <li>An illustration and <a href='#/technote-2'>Technical Note 2</a> providing details on "Exceedance Probability and Confidence in Changes Over Time" can be accessed from here and also by using the drop-down "Technical Note" menu on the top right bar of this site.</li>
          </ol>
          </div>
          </div>
        </div>
